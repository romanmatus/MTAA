    ...
    def processInvite(self):
        ...
        if len(destination) > 0:
            ...
            if destination in registrar and self.checkValidity(destination):
                ...
                self.sendResponse("480 Docasne nedostupny (Temporarily Unavailable)")
        else:
            self.sendResponse("500 server error (Server Internal Error)")
    ...
    def processNonInvite(self):
        ...
        if len(destination) > 0:
            ...
            if destination in registrar and self.checkValidity(destination):
                ...
                self.sendResponse("406 Nemozno akceptovat (Not Acceptable)")
        else:
            self.sendResponse("500 Serverovy error hoppa (Server Internal Error)")
